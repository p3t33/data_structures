...
static void UnitTestSLLInsert(void)
{
    ...
    sl_node_t *sl_handle[2] = {NULL}, *node_to_insert = NULL;

    printf("======================== UnitTestSLLInsert ======================\n");    
    

    /* Node to be inserted created with <8> as data*/
    node_to_insert = SLLCreate(&src_data[2], NULL);
    ...
    SLLInsert(node_to_insert, sl_handle[0]);
...
static void UnitTestSLLInsertAfter(void)
{
    ...
    SLLInsertAfter(node_to_insert, sl_handle[0]);
